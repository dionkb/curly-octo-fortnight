// Tests can be run using Jest Node Package by typing 'NPM test' in command line
...
describe('Square', () => {
    it('should generate a square shaped SVG logo using user inputs', () => {
        ...
        expect(shape.render()).toEqual(`<rect x="50" y="0" width="200px" height="200px" fill="green" />`);
    });
});
